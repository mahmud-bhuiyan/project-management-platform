...
**Current step:** 8.3 (built — pending manual test)
...
| 8 | Task details, comments, activity | 2 / 4 | In progress |
...
| 8.3 | Activity log | [ ] | | Built — auto-log on task/comment/subtask actions + list API; 139 server tests; Postman repo + cloud synced — pending manual test |
...
| 2026-09-13 | 8.3 | Activity log — auto-record + GET `/tasks/:taskId/activity` | Built — 139 server tests; Postman repo + cloud synced; pending manual test |
